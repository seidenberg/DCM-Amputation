...
for i = 1:10
    a(i,1:3) = derivModels.Controls.Early(i).MAP;
    a2(i,1:3) = derivModels.Controls.Early(i).LL;
    b(i,1:3) = derivModels.Controls.Mid(i).MAP;
    c(i,1:3) = derivModels.Controls.Late(i).MAP;
    aa(i,1:3) = derivModels.Amputees.Early(i).MAP;
    bb(i,1:3) = derivModels.Amputees.Mid(i).MAP;
    cc(i,1:3) = derivModels.Amputees.Late(i).MAP;
end
