function [output] = tn_MAP_model2_new(parameters, yDATA, U, P, pHRF,sigmaNoise,priorP)
...
% P.A(2,3) = parameters(1);
% P.A(3,2) = parameters(2);
% P.C(2,2) = parameters(3);
...
[LJ,yBOLD] = compute_logljoint(yDATA, U, P, pHRF, sigmaNoise, priorP);
output = 1/LJ;
end
